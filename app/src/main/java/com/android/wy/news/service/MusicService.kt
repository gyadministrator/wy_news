...
class MusicService : Service() {
    ...
    class MusicBinder(musicService: MusicService) : Binder() {
        ...
        fun setMusic(musicResult: MusicResult) {

            Logger.i("setMusic:$musicResult")
            musicService.defaultMusicState(musicResult)
            ...
            musicService.mMediaHelper?.setOnMediaHelperListener(object :
                ...
                override fun onPrepared(mp: MediaPlayer?) {
                    ...
                    musicService.playMusicState(musicResult)
                    musicService.mMediaHelper?.start()
                }

                override fun onPauseState() {
                    Logger.i("onPauseState: ")
                    musicService.pauseMusicState(musicResult)
                }
            ...
            musicService.mMediaHelper?.setPath(musicResult.pic)
        }
    }
     ...
     * @param musicResult
     */
    private fun startMusicForeground(musicResult: MusicResult) {
        ...
        builder?.setContentTitle(musicResult.title)
        builder?.setContentText(musicResult.desc.toString())
        startForeground(notifyID, builder?.build())

        Glide.with(this).asBitmap().load(musicResult.pic)
     ...
     * @param musicResult
     */
    private fun playMusicState(musicResult: MusicResult) {
        ...
        startMusicForeground(musicResult)
    }
     ...
     * @param musicResult
     */
    private fun defaultMusicState(musicResult: MusicResult) {
    ...
    /**
     * 处于暂停状态下的音乐应该具有的一些配置
     * @param musicResult musicResult
     */
    private fun pauseMusicState(musicResult: MusicResult) {
