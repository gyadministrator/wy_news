...
/*
  ...
  * @Description:
 */
class TopBannerImgAdapter(dataList: ArrayList<House>) :
    BannerAdapter<House, TopBannerImgAdapter.BannerImageViewHolder>(dataList) {
    ...
    override fun onCreateHolder(parent: ViewGroup?, viewType: Int): BannerImageViewHolder {
        val view =
            LayoutInflater.from(parent!!.context)
                .inflate(R.layout.layout_top_banner_item, parent, false)
