...
-keepattributes SourceFile,LineNumberTable
# 混淆采用的算法.
-optimizations !code/simplification/arithmetic,!field/*,!class/merging/*# dump文件列出apk包内所有class的内部结构
...
# >>>>>>>>>>>>>>>----------实体类---------->>>>>>>>>>>>>>>
-keep class com.android.wy.news.entity.** {*;}
-dontwarn com.android.wy.news.entity.**

-keep class com.android.wy.news.locationselect.model.** {*;}
-dontwarn com.android.wy.news.locationselect.model.**

#native方法
-keep class com.android.wy.news.jni.** {*;}
-dontwarn com.android.wy.news.jni.**
# <<<<<<<<<<<<<<<----------实体类----------<<<<<<<<<<<<<<<
